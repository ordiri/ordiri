...
export class ApisApi {
     ...
     */
    public async getAPIVersions (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1APIGroupList;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1APIGroupList;  }>((resolve, reject) => {
