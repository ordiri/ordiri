	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthorizationV1alpha1().RoleBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthorizationV1alpha1().RoleBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&authorizationv1alpha1.RoleBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *roleBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authorizationv1alpha1.RoleBinding{}, f.defaultInformer)
}
