	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthorizationV1alpha1().Roles(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthorizationV1alpha1().Roles(namespace).Watch(context.TODO(), options)
			},
		},
		&authorizationv1alpha1.Role{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *roleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authorizationv1alpha1.Role{}, f.defaultInformer)
}
