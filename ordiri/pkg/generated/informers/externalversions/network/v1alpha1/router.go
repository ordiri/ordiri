...
import (
	...
	v1alpha1 "github.com/ordiri/ordiri/pkg/generated/listers/network/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkV1alpha1().Routers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkV1alpha1().Routers(namespace).Watch(context.TODO(), options)
			},
		},
		&networkv1alpha1.Router{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkv1alpha1.Router{}, f.defaultInformer)
}

func (f *routerInformer) Lister() v1alpha1.RouterLister {
	return v1alpha1.NewRouterLister(f.Informer().GetIndexer())
}
