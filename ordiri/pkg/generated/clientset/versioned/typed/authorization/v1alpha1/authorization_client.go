...
// AuthorizationV1alpha1Client is used to interact with features provided by the authorization.ordiri.com group.
type AuthorizationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AuthorizationV1alpha1Client) Roles(namespace string) RoleInterface {
	return newRoles(c, namespace)
}

func (c *AuthorizationV1alpha1Client) RoleBindings(namespace string) RoleBindingInterface {
	return newRoleBindings(c, namespace)
}

func (c *AuthorizationV1alpha1Client) ServiceAccounts(namespace string) ServiceAccountInterface {
...
// NewForConfigAndClient creates a new AuthorizationV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthorizationV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
