...
var rolebindingsResource = schema.GroupVersionResource{Group: "authorization.ordiri.com", Version: "v1alpha1", Resource: "rolebindings"}

var rolebindingsKind = schema.GroupVersionKind{Group: "authorization.ordiri.com", Version: "v1alpha1", Kind: "RoleBinding"}
...
func (c *FakeRoleBindings) UpdateStatus(ctx context.Context, roleBinding *v1alpha1.RoleBinding, opts v1.UpdateOptions) (*v1alpha1.RoleBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(rolebindingsResource, "status", c.ns, roleBinding), &v1alpha1.RoleBinding{})
