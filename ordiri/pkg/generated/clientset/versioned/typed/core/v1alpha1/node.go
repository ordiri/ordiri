...
func newNodes(c *CoreV1alpha1Client, namespace string) *nodes {
	return &nodes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Node, err error) {
...
func (c *nodes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeList, err error) {
...
func (c *nodes) Create(ctx context.Context, node *v1alpha1.Node, opts v1.CreateOptions) (result *v1alpha1.Node, err error) {
	result = &v1alpha1.Node{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodes").
...
func (c *nodes) Update(ctx context.Context, node *v1alpha1.Node, opts v1.UpdateOptions) (result *v1alpha1.Node, err error) {
	result = &v1alpha1.Node{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodes").
...
func (c *nodes) UpdateStatus(ctx context.Context, node *v1alpha1.Node, opts v1.UpdateOptions) (result *v1alpha1.Node, err error) {
	result = &v1alpha1.Node{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodes").
...
func (c *nodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Node, err error) {
	result = &v1alpha1.Node{}
