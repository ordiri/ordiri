...
type MachineProfileInterface interface {
	Create(ctx context.Context, machineProfile *v1alpha1.MachineProfile, opts v1.CreateOptions) (*v1alpha1.MachineProfile, error)
	Update(ctx context.Context, machineProfile *v1alpha1.MachineProfile, opts v1.UpdateOptions) (*v1alpha1.MachineProfile, error)
	UpdateStatus(ctx context.Context, machineProfile *v1alpha1.MachineProfile, opts v1.UpdateOptions) (*v1alpha1.MachineProfile, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.MachineProfile, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.MachineProfileList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineProfile, err error)
	MachineProfileExpansion
}
...
func (c *machineProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineProfileList, err error) {
...
func (c *machineProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
