...
var machineprofilesKind = schema.GroupVersionKind{Group: "core.ordiri.com", Version: "v1alpha1", Kind: "MachineProfile"}
...
func (c *FakeMachineProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineProfile, err error) {
	...
	return obj.(*v1alpha1.MachineProfile), err
}
...
func (c *FakeMachineProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineProfileList, err error) {
	...
	list := &v1alpha1.MachineProfileList{ListMeta: obj.(*v1alpha1.MachineProfileList).ListMeta}
	for _, item := range obj.(*v1alpha1.MachineProfileList).Items {
