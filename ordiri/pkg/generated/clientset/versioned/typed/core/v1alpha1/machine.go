...
type MachineInterface interface {
	...
	PutReview(ctx context.Context, machineName string, machineReview *v1alpha1.MachineReview, opts v1.UpdateOptions) (*v1alpha1.MachineReview, error)
...
func newMachines(c *CoreV1alpha1Client, namespace string) *machines {
	return &machines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
// PutReview takes the top resource name and the representation of a machineReview and updates it. Returns the server's representation of the machineReview, and an error, if there is any.
func (c *machines) PutReview(ctx context.Context, machineName string, machineReview *v1alpha1.MachineReview, opts v1.UpdateOptions) (result *v1alpha1.MachineReview, err error) {
	result = &v1alpha1.MachineReview{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machines").
		Name(machineName).
