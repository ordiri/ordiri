...
type VirtualMachineReplicaSetLister interface {
	...
	// Get retrieves the VirtualMachineReplicaSet from the index for a given name.
	// Objects returned here must be treated as read-only.
...
// Get retrieves the VirtualMachineReplicaSet from the index for a given name.
func (s *virtualMachineReplicaSetLister) Get(name string) (*v1alpha1.VirtualMachineReplicaSet, error) {
