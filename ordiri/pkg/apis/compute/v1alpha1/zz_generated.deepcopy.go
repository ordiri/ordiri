...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineDevice) DeepCopyInto(out *VirtualMachineDevice) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineDevice.
func (in *VirtualMachineDevice) DeepCopy() *VirtualMachineDevice {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineDevice)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineSpec) DeepCopyInto(out *VirtualMachineSpec) {
	*out = *in
	...
	if in.Devices != nil {
		...
		*out = make([]*VirtualMachineDevice, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VirtualMachineDevice)
