...
//+kubebuilder:rbac:groups=authorization,resources=rolebindings,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=authorization,resources=rolebindings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=authorization,resources=rolebindings/finalizers,verbs=update
...
func (r *RoleBindingReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&authorizationv1alpha1.RoleBinding{}).
		Complete(r)
}
