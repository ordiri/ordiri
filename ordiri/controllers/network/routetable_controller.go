...
//+kubebuilder:rbac:groups=network,resources=routetables,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=network,resources=routetables/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=network,resources=routetables/finalizers,verbs=update
